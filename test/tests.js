...
describe("numToHex", () => {
    // Capacity 1
    it("Example 1", () => expect(PNGArrays.numToHex(0.6153689003735051)).to.equal("F8003266688d960e1b"))
    it("Example 2", () => expect(PNGArrays.numToHex(-0.6153651)).to.equal("F000818486"))
    it("Example 2.5", () => expect(PNGArrays.numToHex(0.6153651)).to.equal("F800818486"))
    it("Example 3", () => expect(PNGArrays.numToHex(10)).to.equal("F80a"))
    it("Example 4", () => expect(PNGArrays.numToHex(5000000)).to.equal("Fd068b735"))
    it("Example 5", () => expect(PNGArrays.numToHex(50000000)).to.equal("Fe045c9c35"))
    it("Example 6", () => expect(PNGArrays.numToHex(99999999)).to.equal("Fe08ba4969"))
    // Capacity 0
    ...
    it("Example 10", () => expect(PNGArrays.numToHex(50000000, 2)).to.equal("F7d045c9c35"))
    it("Example 11", () => expect(PNGArrays.numToHex(2562890624, 2)).to.equal("F7e0eeeeeeee"))
    it("Example 12", () => expect(PNGArrays.numToHex(999999999999, 2)).to.equal("F8201b02b766469"))
    it("Example 13", () => expect(PNGArrays.numToHex(999999999999999, 2)).to.equal("F8407a924652eb469"))
    ...
    it("Example 17", () => expect(PNGArrays.numToHex(10.123, 1, false)).to.equal("F8a83"))
    it("Example 18", () => expect(PNGArrays.numToHex(10.123, 1, true)).to.equal("F80a83"))
    it("Example 19", () => expect(PNGArrays.numToHex(-101010.0123, 1, true)).to.equal("F411ede083"))
    it("Example 20", () => expect(PNGArrays.numToHex(1.000000000000001, 1, true)).to.equal("F8e11"))
})

describe("hexToNum", () => {
    // Capacity 1
    it("Example 1", () => expect(PNGArrays.hexToNum("8003266688d960e1b")).to.equal(0.6153689003735051))
    it("Example 2", () => expect(PNGArrays.hexToNum("000818486")).to.equal(-0.6153651))
    it("Example 2.5", () => expect(PNGArrays.hexToNum("800818486")).to.equal(0.6153651))
    it("Example 3", () => expect(PNGArrays.hexToNum("80a")).to.equal(10))
    it("Example 4", () => expect(PNGArrays.hexToNum("d068b735")).to.equal(5000000))
    it("Example 5", () => expect(PNGArrays.hexToNum("e045c9c35")).to.equal(50000000))
    it("Example 6", () => expect(PNGArrays.hexToNum("e08ba4969")).to.equal(99999999))
    // Capacity 0
    ...
    it("Example 10", () => expect(PNGArrays.hexToNum("7d045c9c35", 2)).to.equal(50000000))
    it("Example 11", () => expect(PNGArrays.hexToNum("7e0eeeeeeee", 2)).to.equal(2562890624))
    it("Example 12", () => expect(PNGArrays.hexToNum("8201b02b766469", 2)).to.equal(999999999999))
    it("Example 13", () => expect(PNGArrays.hexToNum("8407a924652eb469", 2)).to.equal(999999999999999))
    ...
    // leading dec capacity
    it("Example 17", () => expect(PNGArrays.hexToNum("8a83", 1, false)).to.equal(10.123))
    it("Example 18", () => expect(PNGArrays.hexToNum("80a83", 1, true)).to.equal(10.123))
    it("Example 19", () => expect(PNGArrays.hexToNum("411ede083", 1, true)).to.equal(-101010.0123))
    it("Example 20", () => expect(PNGArrays.hexToNum("8e11", 1, true)).to.equal(1.000000000000001))
})
